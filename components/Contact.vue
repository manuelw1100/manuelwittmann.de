<template>
  <div
    class="rn-contact-area rn-section-gap section-separator scrollSpysection mw-100"
    id="contacts"
  >
    <div class="container">
      <div class="row">
              ...
              <div class="rnt-contact-form rwt-dynamic-form row">
                ...
                <div class="col-lg-12">
                  <button
                    ...
                    class="rn-btn mt-5"
                    :disabled="
                      isFormInvalid || !accepted || message?.length < 3
                    "
                  >
                    <span>Nachricht senden</span>
                    <i data-feather="arrow-right"></i>
                  </button>
                  <div v-if="send && !success" class="form-feedback-text">
                    sende Nachricht...
                  </div>
                  <div
                    v-if="success"
                    class="form-feedback-text form-feedback-text--success"
                    v-html="successText"
                  ></div>
                  <div
                    v-if="error"
                    class="form-feedback-text form-feedback-text--error"
                    v-html="errorText"
                  ></div>
                </div>
              </div>
...
const successText = "Vielen Dank für deine Nachricht!";
